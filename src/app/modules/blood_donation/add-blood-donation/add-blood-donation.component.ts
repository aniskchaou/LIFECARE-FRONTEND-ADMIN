...
import BloodDonationValidation from 'src/app/main/validations/bloodDonationValidation';
...
export class AddBloodDonationComponent extends URLLoader implements OnInit {
  ...
  constructor(
    private validation: BloodDonationValidation,
    //private message: CategoryMessage,
    private httpService: HTTPService,
    private router: Router
  ) {
    super();
    this.bloodDonationForm = this.validation.formGroupInstance;
  ...
  get f() {
    return this.bloodDonationForm.controls;
  }
